...
/*-----------------------PHONE-------------------------------*/
    ...
    if(error.length>0){
        ...
        let message = "Доброго дня " + name + " ! Ви подали заявку для участі в тест-драйві на автомобілі " + carName +
            " привід: " +drive+' ! Ваша заявка була схвалена керівництвом, тож приходьте в центральний офіс ' +
