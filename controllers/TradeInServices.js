...
/*email*/
    ...
    if(error.length>0){
        ...
        let message = "Доброго дня " + name + " !\nВи подали заявку для для участі в програмі утилізації та оновлені автомобілів GMC \n" +
            "Ви бажаєте замінити свій " + your_car_mark_model + " " + your_car_releaze + " року на - GMC " + your_new_car + '. \n' +
            "Для повного оцінювання вашого авто завітайте на дилінговий центр GMC який знаходиться за адресами : \n" +
            "м.Київ - вул.Михайла Грушевського 65/2 \n" +
            "м.Харків - вул.Партизанська 34\n" +
            "м.Суми - вул.Мистецька 62 \n" +
            "м.Черкаси - вул.Хоменко 26 \n" +
            "Після оцінювання наші співробітники допоможуть вам виконати всі наступні інструкції для швидкого оновлення вашого авто! \n" +
            "Дякуємо за довіру!";

        let mailOptions={
            to : email,
            subject : "Оцінювання вашого авто",
            text : message
        };
