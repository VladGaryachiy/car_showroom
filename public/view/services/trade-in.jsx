                        ...
                        <div className="modal-dialog tin-modal">
                            <div className="modal-content">
                                <form action="/trade-in-form" method="post" id="test-in" className="trade-in-form" onSubmit={this.TradeInForm}>
                                    ...
                                    <div id="result-message" className="result-message  tin-form-message"></div>
                                        ...
                                        <div className="row">
                                            <div className="col-md-6 col-sm-12 col-xs-12">
                                                ...
                                                <table className="table-for-form-tin-your-car">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span htmlFor="mark-model" className="tin-label-form">Марка, модель:<span className="primary">*</span></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span htmlFor="complectation" className="tin-label-form">Комплектація:<span className="primary">*</span></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span htmlFor='yearOfissue' className="tin-label-form">Рік випуску:<span className="primary">*</span></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span htmlFor='mileage' className="tin-label-form">Пробіг(км):<span className="primary">*</span></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span htmlFor='mileage' className="tin-label-form">Двигун:<span className="primary">*</span></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span htmlFor='engineСapacity' className="tin-label-form">Об'єм двигуна:<span className="primary">*</span></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span htmlFor='typeBodyCar' className="tin-label-form">Кузов:<span className="primary">*</span></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span htmlFor='transmission' className="tin-label-form">Трансмісія:<span className="primary">*</span></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span htmlFor='drive' className="tin-label-form">Привід:<span className="primary">*</span></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span htmlFor='stateCar' className="tin-label-form">Стан:<span className="primary">*</span></span>
                                                        </td>
                                                        <td>
                                            ...
                                            <div className="col-md-6 col-sm-12 col-xs-12">
                                                ...
                                                <table className="table-for-form-tin-your-car">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span htmlFor='yourNewCar' className="tin-label-form yourNewCarLabel">Хочу <br/> замнінити на:<span className="primary">*</span></span>
                                                        </td>
                                                        <td>
                                                ...
                                                <table className="table-for-form-tin-your-car">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span htmlFor='yourName' className="tin-label-form">Ім'я:<span className="primary">*</span></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span htmlFor='yourEmail' className="tin-label-form">Email:<span className="primary">*</span></span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span htmlFor='yourPhone' className="tin-label-form">Телефон:<span className="primary">*</span></span>
                                                        </td>
                                                        <td>
                                                ...
                                                <table className="table-for-form-tin-your-car">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span htmlFor='yourComments' className="tin-label-form commentLabel">Коментарі:</span>
                                                        </td>
                                                        <td>
